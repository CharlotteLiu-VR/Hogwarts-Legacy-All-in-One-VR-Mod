...
def selectProfile():
    ...
    Touch_DoublePulse_Left = TouchHaptics(Touch_Left, touchHapticsPlayer.pulseWithPause(0.06, 1.0, 0.2))
    Touch_DoublePulse_Right = TouchHaptics(Touch_Right, touchHapticsPlayer.pulseWithPause(0.06, 1.0, 0.2))
    Touch_Ancient_Cast_L = TouchHaptics(Touch_Left, touchHapticsPlayer.pulse(0.2, 1.0))
    Touch_Ancient_Cast_R = TouchHaptics(Touch_Right, touchHapticsPlayer.pulse(0.2, 1.0))
    Touch_Ancient_Impact_L = TouchHaptics(Touch_Left, touchHapticsPlayer.pulse(1.8, 0.6))
    Touch_Ancient_Impact_R = TouchHaptics(Touch_Right, touchHapticsPlayer.pulse(1.8, 0.6))
    ...
    gestureTracker.triggerRight.haptics.enter = "MinigunVest_R"
    gestureTracker.triggerRight.haptics.touchEnter = Touch_Enter_Right
    ...
    gestureTracker.meleeRightAltPull.haptics.touchEnter = Touch_Melee_Right
    gestureTracker.meleeRightAltPush.haptics.enter = "Force Push_R"
    gestureTracker.meleeRightAltPush.haptics.touchEnter = Touch_Melee_Right
    ...
    # self defined
    gestureTracker.useLeft.haptics.touchEnter = Touch_Enter_Left
    gestureTracker.useRight.haptics.touchEnter = Touch_Enter_Right
    gestureTracker.useLeftUp.haptics.touchEnter = Touch_Enter_Left
    gestureTracker.useRightUp.haptics.touchEnter = Touch_Enter_Right
    gestureTracker.shakeLeft.haptics.touchEnter = Touch_Ancient_Impact_L
    gestureTracker.shakeRight.haptics.touchEnter = Touch_Ancient_Impact_R
    gestureTracker.thrustLeft.haptics.touchEnter = Touch_Ancient_Impact_L
    gestureTracker.thrustRight.haptics.touchEnter = Touch_Ancient_Impact_R
    gestureTracker.retractLeft.haptics.touchEnter = Touch_Melee_Left
    gestureTracker.retractRight.haptics.touchEnter = Touch_Melee_Right
...
if starting:
    ...
    if skipBhaptics:
        ...
        try:
            ...
            hapticPlayer.registerFromScripts("Equip From Right to Left", 2)
            ...
            #from Half-life Alyx
            hapticPlayer.registerFromScripts("HealthStationUse_1", 4.0) 
            hapticPlayer.registerFromScripts("HealthPenUse_1", 4.0) 
            hapticPlayer.registerFromScripts("HandGrenade_1", 1.0)       
            hapticPlayer.registerFromScripts("GrabbedByBarnacle_1", 4.0)
            hapticPlayer.registerFromScripts("GrabbedByBarnacle_2", 1.0)
            hapticPlayer.registerFromScripts("GrabbedByBarnacle_3", 1.0)
            hapticPlayer.registerFromScripts("GrabbedByBarnacle_4", 1.0)
            hapticPlayer.registerFromScripts("Cough_1", 1.0)
            hapticPlayer.registerFromScripts("Cough_2", 1.0)
            hapticPlayer.registerFromScripts("BackpackStoreClipRight_1", 0.8)
            hapticPlayer.registerFromScripts("BackpackStoreClipLeft_1", 0.8)
            hapticPlayer.registerFromScripts("BackpackRetrieveClipLeft_1", 0.8)
            hapticPlayer.registerFromScripts("BackpackRetrieveClipRight_1", 0.8)
            hapticPlayer.registerFromScripts("BackpackRetrieveResinLeft_1", 0.8)

            #from Blade and Sorcery
            hapticPlayer.registerFromScripts("PoisonDrinking_1", 1.0)
            hapticPlayer.registerFromScripts("PotionDrinking_1", 1.0)
            hapticPlayer.registerFromScripts("PlayerTelekinesisPullRight_1", 1.0)
            hapticPlayer.registerFromScripts("PlayerTelekinesisRepelRight_1", 1.0)
            hapticPlayer.registerFromScripts("DamageRightArmSlashBladeLarge_2", 1.0)
            hapticPlayer.registerFromScripts("SlowMotion_1", 0.2)
            hapticPlayer.registerFromScripts("SwimVest20_1", 0.2)

            #from Skyrim
            hapticPlayer.registerFromScripts("GreybeardPowerAbsorb_1", 0.5)
            hapticPlayer.registerFromScripts("Shout_1", 1.0)
            hapticPlayer.registerFromScripts("Wind_1",  0.05)
            hapticPlayer.registerFromScripts("SoulTrapCaptured_1", 1.0)
            hapticPlayer.registerFromScripts("Healing_1", 1.0)
            hapticPlayer.registerFromScripts("HeartBeat_1", 1.0)
            hapticPlayer.registerFromScripts("HeartBeatFast_1", 1.0)
